...
_context.invoke(function(di) {
	...
	di.getService('ajax').on('request-created', function(evt) {
		var event = new CustomEvent("NittroAjaxRequestCreated", {
			"event": evt
		});
